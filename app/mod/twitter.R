...
keys<-c(
  # consumer_key='AJJLjkeR0SXMWCGa4hUxMQQkP',
  consumer_key='RnQWk2Ht7yfw6o8XrltGLbN3U',
  # consumer_secret='14eRwORTaV6pDf1p1JZ4L3hW1kYounRkaz5c95N2MpjYdMeXdp'
  consumer_secret='Hb7Y71EGUsklpuksgdDkbXCQqAZtgxDKyEysAkIoVbGQNpmvA0'
)
